...
int main() {
    ...
    std::cout << "[TEST] mac_object->is_line_busy == false" << std::endl;
    assert(mac_object.get_is_line_busy() == false);
    std::cout << "[TEST_PASSED]" << std::endl;
    ...
    mac_object.set_is_line_busy();
    std::cout << "[TEST] mac_object.is_line_busy == true" << std::endl;
    assert(mac_object.get_is_line_busy() == true);
    std::cout << "[TEST_PASSED]" << std::endl;

    mac_object.reset_is_line_busy();
    std::cout << "[TEST] mac_object.is_line_busy == false" << std::endl;
    assert(mac_object.get_is_line_busy() == false);
    std::cout << "[TEST_PASSED]" << std::endl;
}